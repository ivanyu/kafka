...
import static org.apache.kafka.connect.mirror.MirrorClientConfig.REPLICATION_POLICY_PREFIX;
...
public class LegacyReplicationPolicy implements ReplicationPolicy, Configurable {
    // TODO name
    // TODO document
    public static final String SOURCE_CONFIG = REPLICATION_POLICY_PREFIX + "source";
    ...
    public void configure(final Map<String, ?> props) {
        ...
        if (props.containsKey(SOURCE_CONFIG)) {
            predefinedSource = (String) props.get(SOURCE_CONFIG);
        } else {
            throw new KafkaException(SOURCE_CONFIG + " must be specified");
        }
    }
